...
LOCK TABLES `legality` WRITE;
/*!40000 ALTER TABLE `legality` DISABLE KEYS */;
INSERT INTO `legality` VALUES (1,'standard'),(2,'expanded');
/*!40000 ALTER TABLE `legality` ENABLE KEYS */;
UNLOCK TABLES;
